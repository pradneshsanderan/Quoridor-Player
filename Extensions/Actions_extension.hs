...
--Step to top Right
stepTopRight :: Cell -> Step
stepTopRight c = (c, cellRightTop  c)

--Step to top Left
stepTopLeft :: Cell -> Step
stepTopLeft c = (c, cellLeftTop  c)

--Step to bottom Right
stepBottomRight :: Cell -> Step
stepBottomRight c = (c, cellRightBottom   c)

--Step to bottom Left
stepBottomLeft :: Cell -> Step
stepBottomLeft c = (c, cellLeftBottom   c)

-- All steps.
allStepsFrom :: Cell -> [Step]
allStepsFrom c = [stepLeft c, stepRight c, stepTop c, stepBottom c, stepTopRight c, stepTopLeft c, stepBottomRight c, stepBottomLeft c]
